...
[![tag](https://img.shields.io/github/tag/samber/slog-multi.svg)](https://go.innotegrity.dev/slogx/handlers/multiwriter/releases)
![Go Version](https://img.shields.io/badge/Go-%3E%3D%201.20.3-%23007d9c)
[![GoDoc](https://godoc.org/go.innotegrity.dev/slogx/handlers/multiwriter?status.svg)](https://pkg.go.dev/go.innotegrity.dev/slogx/handlers/multiwriter)
![Build Status](https://go.innotegrity.dev/slogx/handlers/multiwriter/actions/workflows/test.yml/badge.svg)
[![Go report](https://goreportcard.com/badge/go.innotegrity.dev/slogx/handlers/multiwriter)](https://goreportcard.com/report/go.innotegrity.dev/slogx/handlers/multiwriter)
[![Coverage](https://img.shields.io/codecov/c/github/samber/slog-multi)](https://codecov.io/gh/samber/slog-multi)
[![Contributors](https://img.shields.io/github/contributors/samber/slog-multi)](https://go.innotegrity.dev/slogx/handlers/multiwriter/graphs/contributors)
...
```sh
go get go.innotegrity.dev/slogx/handlers/multiwriter
```
...
GoDoc: [https://pkg.go.dev/go.innotegrity.dev/slogx/handlers/multiwriter](https://pkg.go.dev/go.innotegrity.dev/slogx/handlers/multiwriter)
...
- Fork the [project](https://go.innotegrity.dev/slogx/handlers/multiwriter)
- Fix [open issues](https://go.innotegrity.dev/slogx/handlers/multiwriter/issues) or request new features
