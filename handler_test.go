...
import (
	...
	"go.innotegrity.dev/slog/internal/buffer"
...
func TestJSONAndTextHandlers(t *testing.T) {
	...
	for _, test := range []struct {
		...
		},
		{
			...
			wantJSON:  `{"source":{"function":"go.innotegrity.dev/slog.TestJSONAndTextHandlers","file":"handler_test.go","line":$LINE},"msg":"message"}`,
		},
	} {
